...
//    }
    ...
    public static String changeLang()
    {
        ...
        if (Locale.getDefault().getDisplayLanguage().equals("English")||Locale.getDefault().getDisplayLanguage().equals("الانجليزية")) {
            lang = "en";

        } else if (Locale.getDefault().getDisplayLanguage().equals("Arabic")||Locale.getDefault().getDisplayLanguage().equals("العربية")) {
            lang = "ar";
        }
