...
public class CategoriesHomeAdapter extends RecyclerView.Adapter<CategoriesHomeAdapter.ViewHolder> {
    ...
    public CategoriesHomeAdapter(Context context, HomeActivity activity, List<CategoriesModelDatum> categoriesModelDataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_categories_home,
                parent, false);
